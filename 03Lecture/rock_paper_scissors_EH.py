...
while player_1_selection != "rock" and player_1_selection != "paper" and
...
player_2_selection = input("Player 2 - Enter a choice (rock, paper,
scissors):")
player_2_selection = player_2_selection.lower() #lowercase the input

while player_2_selection != "rock" and player_2_selection != "paper" and
